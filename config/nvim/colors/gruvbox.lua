...
local function setcolor()
  local groups = {
    ...
    StatusLine = { fg = colors.bg0, bg = colors.bg3 },
    ...
    CmpItemKindField = { link = 'Cmp' },
    CmpItemKindProperty = { link = 'Cmp' },
    CmpItemKindEvent = { link = 'Cmp' },
    CmpItemKindText = { link = 'Cmp' },
    CmpItemKindEnum = { link = 'Cmp' },
    CmpItemKindKeyword = { link = 'Cmp' },
    CmpItemKindConstant = { link = 'Cmp' },
    CmpItemKindConstructor = { link = 'Cmp' },
    CmpItemKindReference = { link = 'Cmp' },
    CmpItemKindFunction = { link = 'Cmp' },
    CmpItemKindStruct = { link = 'Cmp' },
    CmpItemKindClass = { link = 'Cmp' },
    CmpItemKindModule = { link = 'Cmp' },
    CmpItemKindOperator = { link = 'Cmp' },
    CmpItemKindVariable = { link = 'Cmp' },
    CmpItemKindFile = { link = 'Cmp' },
    CmpItemKindUnit = { link = 'Cmp' },
    CmpItemKindSnippet = { link = 'Cmp' },
    CmpItemKindFolder = { link = 'Cmp' },
    CmpItemKindMethod = { link = 'Cmp' },
    CmpItemKindValue = { link = 'Cmp' },
    CmpItemKindEnumMember = { link = 'Cmp' },
    CmpItemKindInterface = { link = 'Cmp' },
    CmpItemKindColor = { link = 'Cmp' },
    CmpItemKindTypeParameter = { link = 'Cmp' },
